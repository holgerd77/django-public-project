...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.not_exact'
        db.add_column(u'public_project_event', 'not_exact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.not_exact'
        db.delete_column(u'public_project_event', 'not_exact')
    ...
    models = {
        ...
        u'public_project.event': {
            ...
            'not_exact': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
