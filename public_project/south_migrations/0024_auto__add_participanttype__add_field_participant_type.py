...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'public_project_participanttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'public_project', ['ParticipantType'])

        # Adding field 'Participant.type'
        db.add_column(u'public_project_participant', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public_project.ParticipantType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ParticipantType'
        db.delete_table(u'public_project_participanttype')

        # Deleting field 'Participant.type'
        db.delete_column(u'public_project_participant', 'type_id')
    ...
    models = {
        ...
        u'public_project.participant': {
            'Meta': {'ordering': "['type', 'order', 'name']", 'object_name': 'Participant'},
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['public_project.ParticipantType']", 'null': 'True', 'blank': 'True'})
        },
        u'public_project.participanttype': {
