...
Height: your choice, something around 175px is a good fit).")
    ...
    help_text = _("Show all events or only main events by default.")
    show_all_events = models.BooleanField(_("Show all events"), help_text=help_text, default=True)
...
class Event(models.Model):
    ...
    important = models.BooleanField(_("Main Event"), help_text=help_text)
    search_tags = generic.GenericRelation('SearchTag')
