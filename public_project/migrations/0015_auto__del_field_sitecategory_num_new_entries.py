...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteCategory.num_new_entries'
        db.delete_column(u'public_project_sitecategory', 'num_new_entries')


    def backwards(self, orm):
        # Adding field 'SiteCategory.num_new_entries'
        db.add_column(u'public_project_sitecategory', 'num_new_entries',
