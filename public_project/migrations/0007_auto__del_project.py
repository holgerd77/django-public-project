...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'public_project_project_former_responsible_participants'))

        # Removing M2M table for field responsible_participants on 'Project'
        db.delete_table(db.shorten_name(u'public_project_project_responsible_participants'))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'public_project_project_former_responsible_participants')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'participant_id'])

        # Adding M2M table for field responsible_participants on 'Project'
        m2m_table_name = db.shorten_name(u'public_project_project_responsible_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'public_project.project'], null=False)),
            ('participant', models.ForeignKey(orm[u'public_project.participant'], null=False))
