...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.attribution_url'
        db.add_column(u'public_project_image', 'attribution_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.comments'
        db.add_column(u'public_project_image', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.attribution_url'
        db.delete_column(u'public_project_image', 'attribution_url')

        # Deleting field 'Image.comments'
        db.delete_column(u'public_project_image', 'comments')
