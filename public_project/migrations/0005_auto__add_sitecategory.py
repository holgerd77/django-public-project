...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'SiteCategory'
        db.delete_table(u'public_project_sitecategory')

        # Removing M2M table for field documents on 'SiteCategory'
        db.delete_table(db.shorten_name(u'public_project_sitecategory_documents'))
