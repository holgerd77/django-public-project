...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'public_project_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_participant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_participant', to=orm['public_project.Participant'])),
            ('to_participant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_participant', to=orm['public_project.Participant'])),
            ('function', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'public_project', ['Membership'])

        # Removing M2M table for field belongs_to on 'Participant'
        db.delete_table(db.shorten_name(u'public_project_participant_belongs_to'))


    def backwards(self, orm):
        # Deleting model 'Membership'
        db.delete_table(u'public_project_membership')

        # Adding M2M table for field belongs_to on 'Participant'
        m2m_table_name = db.shorten_name(u'public_project_participant_belongs_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_participant', models.ForeignKey(orm[u'public_project.participant'], null=False)),
            ('to_participant', models.ForeignKey(orm[u'public_project.participant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_participant_id', 'to_participant_id'])
    ...
    models = {
        ...
        u'public_project.membership': {
            ...
            'from_participant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'from_participant'", 'to': u"orm['public_project.Participant']"}),
            'function': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_participant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to_participant'", 'to': u"orm['public_project.Participant']"})
        },
