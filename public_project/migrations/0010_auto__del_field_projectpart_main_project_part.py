...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectPart.main_project_part'
        db.delete_column(u'public_project_projectpart', 'main_project_part_id')

        # Adding M2M table for field main_project_parts on 'ProjectPart'
        m2m_table_name = db.shorten_name(u'public_project_projectpart_main_project_parts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_projectpart', models.ForeignKey(orm[u'public_project.projectpart'], null=False)),
            ('to_projectpart', models.ForeignKey(orm[u'public_project.projectpart'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_projectpart_id', 'to_projectpart_id'])


    def backwards(self, orm):
        # Adding field 'ProjectPart.main_project_part'
        db.add_column(u'public_project_projectpart', 'main_project_part',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public_project.ProjectPart'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field main_project_parts on 'ProjectPart'
        db.delete_table(db.shorten_name(u'public_project_projectpart_main_project_parts'))
