...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfig.show_all_events'
        db.add_column(u'public_project_siteconfig', 'show_all_events',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfig.show_all_events'
        db.delete_column(u'public_project_siteconfig', 'show_all_events')
    ...
    models = {
        ...
        u'public_project.sitecategory': {
            ...
            'num_new_entries': ('django.db.models.fields.IntegerField', [], {'default': '3'})
        },
        u'public_project.siteconfig': {
            ...
            'show_all_events': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
