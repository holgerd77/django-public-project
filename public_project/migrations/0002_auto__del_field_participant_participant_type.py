...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Participant.participant_type'
        db.delete_column(u'public_project_participant', 'participant_type')


    def backwards(self, orm):
        # Adding field 'Participant.participant_type'
        db.add_column(u'public_project_participant', 'participant_type',
                      self.gf('django.db.models.fields.CharField')(default='AD', max_length=2),
                      keep_default=False)
