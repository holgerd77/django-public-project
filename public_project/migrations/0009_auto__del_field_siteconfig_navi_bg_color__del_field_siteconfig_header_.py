...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteConfig.navi_bg_color'
        db.delete_column(u'public_project_siteconfig', 'navi_bg_color')

        # Deleting field 'SiteConfig.header_bg_color'
        db.delete_column(u'public_project_siteconfig', 'header_bg_color')

        # Deleting field 'SiteConfig.important_bg_color'
        db.delete_column(u'public_project_siteconfig', 'important_bg_color')


    def backwards(self, orm):
        # Adding field 'SiteConfig.navi_bg_color'
        db.add_column(u'public_project_siteconfig', 'navi_bg_color',
                      self.gf('django.db.models.fields.CharField')(default='#333333', max_length=7),
                      keep_default=False)

        # Adding field 'SiteConfig.header_bg_color'
        db.add_column(u'public_project_siteconfig', 'header_bg_color',
                      self.gf('django.db.models.fields.CharField')(default='#EEEEEE', max_length=7),
                      keep_default=False)

        # Adding field 'SiteConfig.important_bg_color'
        db.add_column(u'public_project_siteconfig', 'important_bg_color',
                      self.gf('django.db.models.fields.CharField')(default='#990000', max_length=7),
                      keep_default=False)
