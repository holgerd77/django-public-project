...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteConfig.sub_title'
        db.delete_column(u'public_project_siteconfig', 'sub_title')

        # Deleting field 'SiteConfig.sub_title_color'
        db.delete_column(u'public_project_siteconfig', 'sub_title_color')


    def backwards(self, orm):
        # Adding field 'SiteConfig.sub_title'
        db.add_column(u'public_project_siteconfig', 'sub_title',
                      self.gf('django.db.models.fields.CharField')(default=u'Project Website Subtitle', max_length=250),
                      keep_default=False)

        # Adding field 'SiteConfig.sub_title_color'
        db.add_column(u'public_project_siteconfig', 'sub_title_color',
                      self.gf('django.db.models.fields.CharField')(default='#444444', max_length=7),
                      keep_default=False)
