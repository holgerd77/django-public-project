...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectGoalGroup.project_part'
        db.add_column(u'public_project_projectgoalgroup', 'project_part',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public_project.ProjectPart'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectGoalGroup.is_current'
        db.add_column(u'public_project_projectgoalgroup', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectGoalGroup.project_part'
        db.delete_column(u'public_project_projectgoalgroup', 'project_part_id')

        # Deleting field 'ProjectGoalGroup.is_current'
        db.delete_column(u'public_project_projectgoalgroup', 'is_current')
